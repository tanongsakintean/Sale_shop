...
public class Order implements ActionListener {
    ...
    public Order() {
        ...
        this.Order = new JFrame("ระบบขายสินค้า");
        this.c = this.Order.getContentPane();
        ...
        this.Order.add(this.scrollPanel);

        this.Order.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.Order.setSize(1200, 1113);
